...
import { EmailFolderRail, type EmailFolderSelection } from '../components/EmailFolderRail.js';
...
/**
 * Email Redesign: a Gmail-style 3-pane layout - real, provider-discovered
 * folders on the left (EmailFolderRail), the selected folder's content in
 * the middle, and a rearrangeable AI/tools panel on the right
 * (EmailToolsPanel). The previous standalone page (an AURA-drafted
 * approve-before-send queue) is folded in here as the "Compose queue"
 * folder rather than removed - every one of its handlers/state below is
 * unchanged from before this redesign, only relocated.
 */
export function EmailRoute() {
  const [selection, setSelection] = useState<EmailFolderSelection>({ kind: 'compose' });
        ...
        <div className="flex-1 overflow-y-auto p-6">
          <div className="mx-auto max-w-3xl">
            ...
            <div className="flex items-start justify-between gap-4">
              <div>
                <h1 className="text-title font-semibold text-fg">Compose queue</h1>

-- Production-safety directive Phase 16: funnel deletion now writes a real
-- audit event (funnelService.ts deleteFunnel), matching the existing
-- funnel_created/funnel_activated/funnel_deactivated/funnel_enrolled events.

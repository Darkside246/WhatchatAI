...
const ROLE_PERMISSIONS: Record<BusinessRole, readonly Permission[]> = {
  ...
  MANAGER: [
    ...
    'property.view','property.manage','property.approve','retail.view','retail.manage','retail.approve','email.view','email.draft','email.send',
  ],
  SUPERVISOR: [
    'whatsapp.view','whatsapp.send','contacts.view','contacts.edit','crm.view','crm.edit','leads.view','leads.edit','ai.view','automation.view',
    'marketing.view','reports.view','team.manage','property.view','property.manage','property.approve','retail.view','retail.manage','retail.approve','email.view','email.draft','email.send',
  ],
  AGENT: [
  ...
  VIEWER: ['whatsapp.view','contacts.view','crm.view','leads.view','reports.view','property.view','retail.view','email.view'],
};
